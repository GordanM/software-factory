...
.. note:: The example above presents how to compile and install the template library natively on your host machine.
...
The template service depends on the template library. That is reflected in it's CMakeLists.txt file.
The build system will check if the required dependencies are installed on the system through pkg-config_.
...
.. note:: The example above presents how to compile, install and run the template service natively on your host machine.
